...
class SqliteRoomifyTest {
    ...
    fun `parse 2 create statements and generate 2 entities`() {
        ...
        assertEquals(
            """
            // Generated by sqlite-roomify.
            //
            // https://github.com/kboyarshinov/sqlite-roomify
            package dev.test
...
fun assertSuccess(result: SqliteRoomify.Result, func: ((SqliteRoomify.Success) -> Unit)? = null) {
    assert(result is SqliteRoomify.Success) { (result as SqliteRoomify.Error).message }

    func?.invoke(result as SqliteRoomify.Success)
}
